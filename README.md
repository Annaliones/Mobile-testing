...
<div id="badges" align="left"> 
  <img src="https://hsto.org/r/w1560/files/6d2/42e/339/6d242e33924746b588cf53ad5e6a78f0.png", width="300"/>
</div>  

13. Проверка удобства и логичности расположение блоков с контентом
14. Pixel Perfect -способ вёрстки строго по макету, при котором размеры и интервалы из макета соблюдаются с точностью до нескольких пикселей
15. Опираться на гайдлайны при раазработке приложения
  - Google Material Design System
  - Apple Human Interface Guidelines

## <a name="stress"></a>  Стрессовое тестирование
1. Нехватка памяти
2. Влияние на аккумулятор
3. Низкая пропускная способность сети
4. Отказы
5. Большое количество взаимодействий пользователя с приложением
...
1. Производительность приложений в периоды пиковой нагрузки и непрерывного ввода с клавиатуры
2. Проверка производительности заставки и обеспечение того, чтобы она оставалась на экране менее 3-4 секунд
3. Производительность приложения при низком заряде батареи устройства и условиях зарядки
4. Разверните службы мониторинга в реальном времени , чтобы контролировать вычислительную мощность приложения
5. Интеграция с устройством и другими приложениями без снижения производительности
6. Успешная установка/удаление приложения в течение желаемого периода времени
7. Отображение сообщений об ошибках и корректное завершение работы при нехватке памяти
8. Производительность приложения во время проблем с сетью и предупреждений об ошибках
9. Производительность приложений, когда Сеть снова в действии
